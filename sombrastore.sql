...
CREATE TABLE `baskets` (
  ...
  CONSTRAINT `article` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `users` VALUES (1,'user','user@mail.com','shbyrfkzkz2',1,0,'2015-01-22');
...
-- Dump completed on 2015-01-23  0:20:49
